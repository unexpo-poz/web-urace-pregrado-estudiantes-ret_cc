...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/ret_sc/';

$lapsoProceso		= '2023-2';
$tLapso				= ' Lapso '.$lapsoProceso;

$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/retiros/retiros_cola-'.$lapsoProceso.'.log';
